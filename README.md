...
│  │              │  │              │  │              │  │
│  │ Yahoo Finance│  │ EMA200       │  │ Gemini REST  │  │
...
| ETF | 第一優先 | 第二備援 | 第三備援 |
|-----|---------|---------|---------|
| 0050、00679B | TWSE Open API | Yahoo Finance | Alpha Vantage |
| VOO、GLD | Yahoo Finance | Alpha Vantage | — |
| VIX | FRED（VIXCLS） | Yahoo Finance（^VIX） | Alpha Vantage（VIXY / UVXY） |
...
| 狀況 | 原因 | 影響 |
|------|------|------|
| ETF 卡未出現 | Yahoo Finance 無資料且 AV 配額耗盡 | 僅文字摘要 + Gemini 發出，ETF 卡自動跳過 |
